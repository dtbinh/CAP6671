...
public class VacAgentWithState extends Agent{
	...
	private void thresholdDetected(){
		...
		else if((roomGrid[y][x+1] <=roomGrid[y][x-1]) && (roomGrid[y][x+1] <= roomGrid[y-1][x]) && (roomGrid[y][x+1] <= roomGrid[y+1][x]))
		{
			switch (this.currentDirection){
				case 0:
					this.turnRight = true;
		...
		else if((roomGrid[y+1][x] <=roomGrid[y][x-1]) && (roomGrid[y+1][x] <= roomGrid[y][x+1]) && (roomGrid[y+1][x] <= roomGrid[y-1][x]))
		{
			switch (this.currentDirection){
				case 0:
					this.turnRight = true;
	...
	public void see(Percept p) {
		...
		// roomGrid, and choose the direction with the fewest visits (lowest threshold)
